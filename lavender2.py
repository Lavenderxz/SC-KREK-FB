...
| Jika Ada Yang Eror Anda Bisa Mengubungi Sayaaa Di. |
...
def menu():
    ...
    kotak()
#    banner()
    print (' %s[∆] Auhtor    : Romi & Mbokey'%(P))
    print (' [∆] gh auhtor : https://github.com/Mbokey')
    print (' [∆] gh auhtor : https://github.com/Mark-Zuck')
    print (jembut)
